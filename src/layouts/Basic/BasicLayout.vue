...
const defaultMenuTabsData = {
  tabs:
    userTokens.type !== 'admin'
      ? { 归档邮件查询: { id: 0, title: '归档邮件查询', path: '/employ/home', close: false } }
      : {
          // 归档邮件查询: { id: 999, title: '归档邮件查询', path: '/employ/home', close: false },
          // 邮件恢复队列: { id: 9991, title: '邮件恢复队列', path: '/employ/list', close: false },
